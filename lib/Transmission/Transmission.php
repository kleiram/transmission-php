...
use Transmission\Model\TorrentInterface;
...
class Transmission
{
     ...
     * @param bool             $now
     */
    public function start(TorrentInterface $torrent, $now = false)
    {
        $this->getClient()->call(
     ...
     * @param TorrentInterface $torrent
     */
    public function remove(TorrentInterface $torrent, $localData = false)
    {
